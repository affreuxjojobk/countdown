...
import flyerImage from './assets/earlybird.jpg';
import TeaserVideo from './components/TeaserVideo'; // import du composant teaser
import OfficialTicketLink from './components/OfficialTicketLink'; // ajout
